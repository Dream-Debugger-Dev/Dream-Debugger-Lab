...
sum = num1 + num2 #sum veriable performing sum of veriable num1 and num2 values

print("Sum of 1st and 2nd number is:", sum) #after entering 2 numbers is print sum variable value which will be sum of num1 and num2 
